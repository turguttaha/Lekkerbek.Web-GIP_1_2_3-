...
namespace Lekkerbek.Web.Data
{
    public class LekkerbekContext : IdentityDbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=ucllgipsqlteam2v3.database.windows.net;Database=gip2db;user=gipteam2;password=Gipteam_2;trustservercertificate=true;");
