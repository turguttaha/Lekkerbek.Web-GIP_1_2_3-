...
namespace Lekkerbek.Web.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> EditOrder(int id, [Bind("OrderID,Finished,CustomerID")] Order order,IFormCollection collection)
        {
            ...
            var timeSlots = await _context.TimeSlots.FindAsync(order.TimeSlotID);

            TempData["SelectDate"] = timeSlots.StartTimeSlot.ToString("yyyy-MM-dd");
            TempData["time"] = timeSlots.StartTimeSlot.ToString("H:mm");
